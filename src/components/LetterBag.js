    ...
    <div style={{ textAlign: 'center' }}>
      ...
      <div>
        <h4 style={{ marginBottom: '20px' }}>
          ...
          <a href='https://wordfinder.yourdictionary.com/blog/bananagrams-dictionary-find-the-right-and-valid-words/' target='_blank' rel='noopener noreferrer'>
            valid word
          </a>
          .<br />
          To use your hand, click or tap on an empty square in the Game Board and begin typing from your available letters.
          <br />
